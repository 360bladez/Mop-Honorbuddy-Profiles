...
namespace Honorbuddy.QuestBehaviorCore.XmlElements
{
    public class WaypointType : QuestBehaviorXmlBase
    {
        ...
        public override string SubversionId { get { return "$Id: WaypointType.cs 1655 2014-08-27 18:57:15Z Dogan $"; } }
        public override string SubversionRevision { get { return "$Rev: 1655 $"; } }
