...
namespace Honorbuddy.QuestBehaviorCore.XmlElements
{
    public class VehicleAbilitiesType : QuestBehaviorXmlBase
    {
		...
		public override string SubversionId { get { return "$Id: VehicleAbilitiesType.cs 1632 2014-08-16 05:26:42Z chinajade $"; } }
		public override string SubversionRevision { get { return "$Rev: 1632 $"; } }
