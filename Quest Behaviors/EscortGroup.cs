...
namespace Honorbuddy.Quest_Behaviors.EscortGroup
{
	...
	public class EscortGroup : CustomForcedBehavior
	{
		...
		public override string SubversionId { get { return "$Id: EscortGroup.cs 1597 2014-07-18 16:44:13Z Dogan $"; } }
		public override string SubversionRevision { get { return "$Rev: 1597 $"; } }
		#endregion
