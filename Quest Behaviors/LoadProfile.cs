...
namespace Honorbuddy.Quest_Behaviors.LoadProfile
{
	...
	public class LoadProfile : CustomForcedBehavior
	{
		...
		public override string SubversionId { get { return ("$Id: LoadProfile.cs 1600 2014-07-18 16:55:25Z highvoltz $"); } }
		public override string SubversionRevision { get { return ("$Revision: 1600 $"); } }
